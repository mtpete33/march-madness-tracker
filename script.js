                ...
                data.games.forEach(game => {
                    ...
                    const gameCard = `
                        <div class="game-card">
                            ...
                            <p><strong>${gameData.currentPeriod === "Halftime" ? "Halftime" : (gameData.contestClock ? `${gameData.currentPeriod} - ${gameData.contestClock}` : gameData.finalMessage || gameData.startTime)}</strong></p>
                        </div>
                    `;
